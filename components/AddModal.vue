          ...
          <ValidationObserver v-slot="{handleSubmit}">
            <form class="grid gap-8" @submit.prevent="handleSubmit(storeDiscussion)">
                ...
                <div class="mt-5 sm:mt-6">
                  <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-[#727ABE] hover:bg-[#5d64a7] text-white text-lg w-full py-3">Добавить</button>
              </div>
            </form>
          </ValidationObserver>
      </div>
