<template>
    <div class="py-14 px-10 w-full overflow-scroll">
        <div class="flex">
            <h3 class="text-sm font-medium text-[#B3B9C9] pb-5 pr-2">Сотрудники</h3>
            <h3 class="text-sm font-medium text-[#B3B9C9] pb-5 pr-2"> ></h3>
            <h3 class="text-sm font-medium text-[#727ABE] pb-5">Добавить сотрудника</h3>
        </div>
        <div class="grid gap-8">
            <ValidationObserver v-slot="{handleSubmit}">
                <form class="grid gap-8 grid-cols-6" @submit.prevent="handleSubmit(getEmployees)">
