<template>
    <div class="py-14 px-10 w-full overflow-scroll">
        <div class="flex">
            ...
            <h3 class="text-sm font-medium text-[#727ABE] pb-5">Добавить центр</h3>
        </div>
        <div class="grid gap-x-16 grid-cols-3">
            <div class="grid gap-8 col-span-2">
                <ValidationObserver v-slot="{handleSubmit}">
                    <form class="grid gap-8 grid-cols-2" @submit.prevent="handleSubmit(getHelp)">
        ...
        async getHelp() {
            let payload = {
                ...
                form: {
                    ...
                    lat: Number(this.$refs.reference.latitude),
                    long: Number(this.$refs.reference.longitude),
